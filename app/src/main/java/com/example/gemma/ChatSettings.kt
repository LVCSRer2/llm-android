...
data class ChatSettings(
    ...
    companion object {
        ...
        fun load(context: Context): ChatSettings {
            ...
            return ChatSettings(
                systemPrompt = prefs.getString("system_prompt", null) ?: ChatSettings().systemPrompt,
                ...
                cpuOptimization = prefs.getBoolean("cpu_optimization", true),
        ...
        fun save(context: Context, settings: ChatSettings) {
            context.getSharedPreferences(PREFS_NAME, Context.MODE_PRIVATE).edit()
                ...
                .putBoolean("cpu_optimization", settings.cpuOptimization)
